...
const SkillSection = ({
	...
	return (
		<section className="relative overflow-clip">
			<div className="absolute bg-linear-to-r from-primarydark to-transparent h-full w-[150px] z-[10]" />

			<div className="absolute bg-linear-to-l from-primarydark to-transparent right-0 h-full w-[150px] z-[10]" />
